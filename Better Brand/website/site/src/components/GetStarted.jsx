  ...
  return (
    ...
    >
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="cta-anim text-ivory/50 text-base sm:text-lg max-w-xl mx-auto mb-10 leading-relaxed">
        ...
        <a
          href="#"
          className="cta-anim btn-magnetic inline-flex items-center gap-2 bg-champagne text-obsidian px-8 py-4 rounded-full text-base sm:text-lg font-semibold"
        >
        ...
        <p className="cta-anim text-ivory/30 text-sm mt-6">
